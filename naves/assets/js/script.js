function start() {
    ...
    function colisao() {
        ...
        if (colisao3.length>0) {
            ...
            pontos = pontos+100;
            velocidade = velocidade + 0.3; // aumenta a velocidade do inimigo
            inimigo1X = parseInt($("#inimigo1").css("left"));
            inimigo1Y = parseInt($("#inimigo1").css("top"));
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Sua pontuacao foi: " + pontos + "</p>" + "<div id='reinicia'><button type='button' class='btn btn-dark' onClick=reiniciaJogo()>Jogar Novamente</button></div>");
